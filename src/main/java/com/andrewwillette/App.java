...
public class App {
     ...
     * @throws IOException If the clientSecret.json file cannot be found.
     */
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        final String spreadsheetId = "1lslADohsVfyl-VbzIdB9lFt3_4eMGFGWskwZZZF3s2E";
        final String range = "A1:J29";
        ...
        if (values == null || values.isEmpty()) {
            ...
            while (i < values.size()) {
                ...
                PaymentRow pRow = new PaymentRow(values.get(i));
                System.out.println(pRow);
                System.out.println(pRow.getRoomatesPayment());
                i++;
            }
        }
    }
